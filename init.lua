...
local create_maps = function(mode, plug, combo, target)
    ...
    if mode:find("n") then
        ...
        if not config.user_maps_only and vim.fn.hasmapto(plg, "n") == 0 then
            ...
            vim.print("vim.api.nvim_buf_set_keymap(0, \"n\",\"" .. cmd .. "\", \"" .. plg .. "\", ", opts, ")")
        end
    end
    if mode:find("v") then
        ...
        if not config.user_maps_only and vim.fn.hasmapto(plg, "v") == 0 then
            ...
            vim.print("vim.api.nvim_buf_set_keymap(0, \"v\",\"" .. cmd .. "\", \"" .. plg .. "\", ", opts, ")")
        end
    end
    if config.insert_mode_cmds and mode:find("i") then
        ...
        if not config.user_maps_only and vim.fn.hasmapto(plg, "i") == 0 then
            ...
            vim.print("vim.api.nvim_buf_set_keymap(0, \"i\",\"" .. cmd .. "\", \"" .. plg .. "\", ", opts, ")")
        end
    end
end
...
vim.print(M.create("r"))
vim.print(M.create("rmd"))
vim.print(M.create("rnoweb"))
vim.print(M.create("quarto"))
vim.print(M.create("rdoc"))
vim.print(M.create("rbrowser"))
-- vim.print(M)
